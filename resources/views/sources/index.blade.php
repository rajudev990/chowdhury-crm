                ...
                <div class="overflow-x-auto">
                    ...
                    <div id="statusSidebar"
                        ...
                        <div class="flex items-center gap-3 px-5 py-4 bg-[#1A3A66] text-white">
                            ...
                            <h2 class="text-lg font-semibold" id="sidebarTitle">Add Project Source</h2>
                        </div>

                        <!-- Form -->
                        <form id="statusForm" action="{{ route('sources.store') }}" method="POST" class="p-5 space-y-4">
                            @csrf
...
<script>
    ...
    function openStatusSidebar() {
        ...
        document.getElementById('sidebarTitle').textContent = 'Add Project Source';
        document.getElementById('statusForm').action = '{{ route("sources.store") }}';
    ...
    function openEditSidebar(id, name, status) {
        ...
        document.getElementById('sidebarTitle').textContent = 'Edit Project Source';
        document.getElementById('statusForm').action = '/sources/' + id;
